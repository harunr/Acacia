...
;(function($){
	$(function(){
        ...
        $("div.phone-nav").click(function(){
            $("#header-section").addClass("nav-open");
            $(this).hide()
            $("div.close-btn").show()
            $(".main-nav").slideDown()
        ...
        $("div.close-btn").click(function(){
            $("#header-section").removeClass("nav-open");
            $(this).hide()
            $("div.phone-nav").show()
            $(".main-nav").slideUp()
        });
        ...
        $('.faq-item').click(function(){
            ...
            $('.faq-item').find('p:visible').slideUp()
    ...
    $(window).load(function(){
        // Begin common slider
        if ( $('div.what-our-text-slider').length == 0 ) return false

        $('div.what-our-text-slider').flexslider({
            animation:"slide",
            slideshow: true,
            directionNav: false,
            controlNav:true,
    ...
    $(window).load(function(){
        // Begin common slider
        if ( $('div.related-slider').length == 0 ) return false

        $('div.related-slider').flexslider({
            animation:"slide",
            slideshow: false,
            directionNav: true,
            controlNav:false,
